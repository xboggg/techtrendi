...
export default function AdSenseCalculator() {
  ...
  const handleShare = async () => {
    const text = [
      ...
      `CTR: ${ctr}%`,
      `CPC: ${formatCurrency(cpc, currency)}`,
      `Niche: ${niche}`,
      "",
      `Daily Revenue: ${formatCurrency(results.dailyRevenue, currency)}`,
      `Monthly Revenue: ${formatCurrency(results.monthlyRevenue, currency)}`,
      `Yearly Revenue: ${formatCurrency(results.yearlyRevenue, currency)}`,
      `RPM: ${formatCurrency(results.rpm, currency)}`,
      "",
              ...
              <CardContent>
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    />
                    <div className="flex justify-between text-xs text-muted-foreground">
                      <span>{formatCurrency(0.01, currency)}</span>
                      <span>{formatCurrency(2.5, currency)}</span>
                      <span>{formatCurrency(5, currency)}</span>
                    </div>
                    <p className="text-xs text-muted-foreground flex items-start gap-1">
                      <Info className="w-3 h-3 mt-0.5 shrink-0" />
            ...
            <Card className="border-primary/20 bg-gradient-to-br from-primary/5 to-transparent">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-3 rounded-lg border bg-card">
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {formatCurrency(results.yearlyRevenue, currency)}
                  </div>
                ...
                <div className="p-3 rounded-lg border bg-card">
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {formatCurrency(results.rpm, currency)}
                  </div>
                  <div className="text-xs text-muted-foreground mt-1">
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatCurrency(cpc, currency)}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  {growthRate > 0 && (
                    <div className="flex justify-between border-t pt-2">
                      ...
                      <span className="font-semibold text-primary">
                        {formatCurrency(projection[11]?.revenue ?? 0, currency)}
                      </span>
                    </div>
                  )}
                </div>

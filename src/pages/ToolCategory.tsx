...
const categoriesData: Record<string, CategoryData> = {
  ...
  other: {
    ...
    tools: [
      ...
      { icon: TimerIcon, title: "Life & Time Calculators", description: "Birthday countdown, life in weeks, retirement countdown, and more", href: "/tools/life-calculators", tier: "free", isNew: true, gradient: "from-indigo-500 to-purple-600" },

...
const categoriesData: Record<string, CategoryData> = {
  business: {
    ...
    tools: [
      ...
      { icon: DollarSign, title: "Invoice Chaser", description: "Automated payment reminders that chase late-paying clients", href: "/tools/invoice-chaser", tier: "free", gradient: "from-green-500 to-emerald-600" },
      { icon: FileSignature, title: "Proposal Generator", description: "Create professional proposals and quotes that win clients", href: "/tools/proposal-generator", tier: "free", isNew: true, gradient: "from-purple-500 to-violet-600" },
      { icon: Users, title: "Simple CRM", description: "Track customers, deals, and follow-ups in one dashboard", href: "/tools/simple-crm", tier: "free", isNew: true, gradient: "from-pink-500 to-rose-600" },
      { icon: Calendar, title: "Appointment Booking", description: "Let clients book appointments with WhatsApp confirmations", href: "/tools/appointment-booking", tier: "free", isNew: true, gradient: "from-orange-500 to-red-600" },
      { icon: Building, title: "Client Portal", description: "Share files, invoices, and messages with clients in one place", href: "/tools/client-portal", tier: "free", isNew: true, gradient: "from-teal-500 to-cyan-600" },
  ...
  career: {
    ...
    tools: [
      ...
      { icon: Users, title: "Network CRM", description: "Keep in touch with your professional network", href: "/tools/network-crm", tier: "free", isNew: true, gradient: "from-purple-500 to-violet-600" },
  ...
  creator: {
    ...
    tools: [
      ...
      { icon: Send, title: "Cold Email Writer", description: "Write effective cold emails that get responses", href: "/tools/cold-email-writer", tier: "free", isNew: true, gradient: "from-red-500 to-rose-600" },

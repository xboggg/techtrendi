...
export default function SecurityPreview() {
  ...
  return (
    <Layout>
      <SEOHead title="Cyber Safety Hub — Stay Safe Online in Ghana" description="Plain-language online safety for Ghana — scams, MoMo fraud, passwords and privacy. Sourced from Ghana's CSA and SEC." noindex canonical="/security-preview" />
